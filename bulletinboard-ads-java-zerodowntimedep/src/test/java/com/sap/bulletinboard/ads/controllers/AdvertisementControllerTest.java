...
public class AdvertisementControllerTest {
    ...
    public void navigatePages() throws Exception {
        ...
        assertThat(linkHeader).isEqualTo("</api/v2/ads/pages/1>; rel=\"next\"");
		...
		assertThat(linkHeader2ndPage)
				.isEqualTo("</api/v2/ads/pages/0>; rel=\"previous\", </api/v2/ads/pages/2>; rel=\"next\"");
        ...
        assertThat(linkHeader3rdPage).isEqualTo("</api/v2/ads/pages/1>; rel=\"previous\"");
